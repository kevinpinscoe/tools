...
- `gitcf` stages and commits a single file to its containing git repository with an auto-generated message (`Added <name>` or `Modified <name>`). Works from any working directory.
